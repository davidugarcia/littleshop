   ...
   <form class="espacio" action="post">
      ...
      <div class="row">
         <div class="col-lg-12 mb-3">
            ...
            <input type="text" class="form-control is-valid" name="user" value="Eliexer" required>
      ...
      <div class="row">
         <div class="col-lg-12 ">
            ...
            <input type="text" class="form-control is-valid" name="pass" value="davi@yahoo.es" required>
            <div class="valid-feedback">
                        Looks good!
            </div>
         </div>
